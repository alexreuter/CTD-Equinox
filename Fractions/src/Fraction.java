...
public class Fraction 
{
    ...
    {
    	Fraction result = new Fraction(myNumerator*other.myDenominator - other.myNumerator * myDenominator, myDenominator*other.myDenominator);
    	return result;
    }
    ...
    public String toString()
    {
    	...
    	else if(Math.abs(myNumerator)>Math.abs(myDenominator))
    	{
    ...
    private void simplify()
    {
    	...
    	else if(myNumerator < 0 && myDenominator < 0)
    	{
