...
public class LargeNumber 
{
	...
	public static LargeNumber multiplyDigit(LargeNumber other, int digit)
	{
		...
		for(int i=other.toString().length();i>0;i--)
		{
			int total = 0;
			int digit1 = Integer.parseInt(other.toString().substring(i-1, i));
...
//		
//
//		LargeNumber results = new LargeNumber("0");
//		
//		//Can use myNumber.length because should be the same length by now
//		
//		for(int i = 0;i<myNumber.length();i++)
//		{			
//			String zeroHolder = "";
////			This large line adds the returned value from multiplying by a digit to the previous results
////			System.out.println("Substring: " + myNumber.substring(i,i+1));
////			System.out.println("other" + other);
////			System.out.println("Mult digit " + multiplyDigit(other,Integer.parseInt(myNumber.substring(i,i+1).toString())));
////			System.out.println("One step: " + multiplyDigit(other,9));
//			zeroHolder = multiplyDigit(other,Integer.parseInt(myNumber.substring(i,i+1))).toString();
////			System.out.println("Digit1: " + Integer.parseInt(myNumber.substring(i,i+1)));
//			System.out.println("External: " + multiplyDigit(other,Integer.parseInt(myNumber.substring(i,i+1))));
//			//Adding zeros
...
//				zeroHolder = zeroHolder + "0";
//			}
//			
//			LargeNumber placeholder = new LargeNumber(zeroHolder);
////			System.out.println("One step: " + zeroHolder);
//			results.myNumber =  placeholder.plus(results).toString();
//		}
//		
//		return results;
		
		System.out.println("Multin" + LargeNumber.multiplyDigit(other, Integer.parseInt(myNumber)));
		return LargeNumber.multiplyDigit(other, Integer.parseInt(myNumber));
